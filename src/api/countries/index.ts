...
export const AddCountries  = async(newcountry : Partial<CountryProp>):Promise<CountryProp> => {
    try {
...
export const UpdateCountries = async(country : CountryProp):Promise<CountryProp>=>{
    try {
